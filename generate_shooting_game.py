...
def generate_svg():
    ...
    nozzle_x = gun_start_x + GUN_WIDTH // 2
    nozzle_y = gun_y
    ...
    <!-- Gunshot Sound -->
    <audio autoplay loop>
        <source src="https://actions.google.com/sounds/v1/impacts/gunshot.ogg" type="audio/ogg"/>
    </audio>
...
'''
    ...
    # Bullets INSIDE gun group (important fix)
    for i in range(8):
        delay = i * 1.2
        svg += f'''
        <circle cx="{nozzle_x}"
